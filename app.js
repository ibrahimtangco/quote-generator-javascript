...
const quotesArray = [
  ...
  {
    quote: "If you are no longer struggling, you are no longer improving.",
    author: "Ibrahim Tangco",
  },
];

button.addEventListener("click", () => {
  const randNum = Math.floor(Math.random() * quotesArray.length);
  qTag.innerText = quotesArray[randNum].quote;
  author.innerText = quotesArray[randNum].author;
});
